...
def convert_to_central_time(iso_str):
    ...
    try:
        ...
        # Replaces "Z" suffix with proper offset formatting lookup
...
def main():
    # Ingest the environment variables set by the workflow script
    ...
    # Recursive deep match matches the subfolder structure generated by the unzip step
    ...
    with open(summary_file, 'w', encoding='utf-8') as out:
        ...
        # --- DOCK HISTORICAL SCAN FRESHNESS TIMESTAMPS ---
